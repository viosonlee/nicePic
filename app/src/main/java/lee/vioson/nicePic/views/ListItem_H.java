 ...
 * Todo
 */
public class ListItem_H extends LinearLayout {
    ...
    public ListItem_H(Context context) {
        this(context, null);
    }

    public ListItem_H(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public ListItem_H(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        View view = LayoutInflater.from(context).inflate(R.layout.view_list_item_h, this);
